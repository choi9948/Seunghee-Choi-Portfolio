...
const TravelMap: React.FC = () => {
  ...
  return (
    <div className="relative w-full aspect-[2/1] bg-[hsl(var(--card))] rounded-3xl border border-white/5 overflow-hidden group">
      ...
      <svg
        viewBox="0 0 100 100"
        className="w-full h-full opacity-20 fill-[hsl(var(--muted-foreground))] transition-opacity group-hover:opacity-30"
        preserveAspectRatio="xMidYMid slice"
      >
        <path d="M15,40 Q20,35 25,40 T35,35 T45,40 T55,35 T65,40 T75,35 T85,40 T95,35 V60 Q85,65 75,60 T65,65 T55,60 T45,65 T35,60 T25,65 T15,60 Z" />
        <path d="M20,70 Q30,65 40,70 T60,65 T80,70" stroke="currentColor" fill="none" strokeWidth="0.5" />
      </svg>
      ...
      <div className="absolute bottom-4 left-6 text-[10px] font-mono text-[hsl(var(--muted-foreground))] uppercase tracking-widest">
